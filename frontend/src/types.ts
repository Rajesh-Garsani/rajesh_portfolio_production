export interface PersonalInfo { name: string; title: string; email: string; phone: string; location: string; github: string; linkedin: string; summary: string; available_for_work?: boolean; }
...
export type DemoType = "security" | "scraping";
